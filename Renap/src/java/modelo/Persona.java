...
public class Persona {
    ...
    public Persona(String cui, String nombre, String apellido, String sexo, String estadoCivil, int estatusNacional, Date fechaDeNacimiento, int idLugarN, Date fechaDeDefuncion, int idLugarD, int idVecindad) {
        this.cui = cui;
        this.nombre = nombre;
